...
void kth_py_native_chain_input_list_capsule_dtor(PyObject* capsule) {
    if ( ! PyCapsule_IsValid(capsule, KTH_PY_CAPSULE_CHAIN_INPUT_LIST)) return;
    kth_input_list_mut_t handle = (kth_input_list_mut_t)PyCapsule_GetPointer(capsule, KTH_PY_CAPSULE_CHAIN_INPUT_LIST);
    if (handle != NULL) kth_chain_input_list_destruct(handle);
}
...
PyObject* kth_py_native_chain_input_list_push_back(PyObject* self, PyObject* args, PyObject* kwds) {
    ...
    kth_chain_input_list_push_back(list_handle, elem_handle);
    Py_RETURN_NONE;
}

PyObject* kth_py_native_chain_input_list_destruct(PyObject* self, PyObject* py_arg0) {
    kth_input_list_mut_t list_handle = (kth_input_list_mut_t)PyCapsule_GetPointer(py_arg0, KTH_PY_CAPSULE_CHAIN_INPUT_LIST);
    if (list_handle == NULL) return NULL;
    kth_chain_input_list_destruct(list_handle);
...
PyObject* kth_py_native_chain_input_list_nth(PyObject* self, PyObject* args, PyObject* kwds) {
...
PyObject* kth_py_native_chain_input_list_erase(PyObject* self, PyObject* args, PyObject* kwds) {
    static char* kwlist[] = {(char*)"list", (char*)"index", NULL};
    PyObject* py_list = NULL;
    unsigned long long index = 0;
    if ( ! PyArg_ParseTupleAndKeywords(args, kwds, "OK", kwlist, &py_list, &index)) {
...
PyMethodDef kth_py_native_chain_input_list_methods[] = {
    {"chain_input_list_construct_default", (PyCFunction)kth_py_native_chain_input_list_construct_default, METH_NOARGS, NULL},
    {"chain_input_list_push_back", (PyCFunction)kth_py_native_chain_input_list_push_back, METH_VARARGS | METH_KEYWORDS, NULL},
    {"chain_input_list_destruct", (PyCFunction)kth_py_native_chain_input_list_destruct, METH_O, NULL},
    {"chain_input_list_count", (PyCFunction)kth_py_native_chain_input_list_count, METH_O, NULL},
    {"chain_input_list_nth", (PyCFunction)kth_py_native_chain_input_list_nth, METH_VARARGS | METH_KEYWORDS, NULL},
    {"chain_input_list_assign_at", (PyCFunction)kth_py_native_chain_input_list_assign_at, METH_VARARGS | METH_KEYWORDS, NULL},
    {"chain_input_list_erase", (PyCFunction)kth_py_native_chain_input_list_erase, METH_VARARGS | METH_KEYWORDS, NULL},
