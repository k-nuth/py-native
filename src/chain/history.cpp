...
PyObject* kth_py_native_history_compact_list_destruct(PyObject* self, PyObject* args) {
    ...
    kth_history_compact_list_mut_t list = (kth_history_compact_list_mut_t)get_ptr(py_history_compact_list);
...
PyObject* kth_py_native_history_compact_list_nth(PyObject* self, PyObject* args) {
    ...
    kth_history_compact_mut_t hc = kth_chain_history_compact_list_nth(list, py_n);
...
PyObject* kth_py_native_history_compact_point_kind(PyObject* self, PyObject* args) {
    ...
    kth_history_compact_mut_t hist = (kth_history_compact_mut_t)get_ptr(py_history_compact);
