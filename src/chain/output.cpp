...
kth_py_native_chain_output_construct_default(PyObject* self, PyObject* Py_UNUSED(args)) {
    auto const result = kth_chain_output_construct_default();
    if (result == NULL) {
        PyErr_SetString(PyExc_MemoryError, "kth: allocation failed");
        return NULL;
    }
    PyObject* capsule = PyCapsule_New((void*)result, KTH_PY_CAPSULE_CHAIN_OUTPUT, kth_py_native_chain_output_capsule_dtor);
    if (capsule == NULL) {
        kth_chain_output_destruct(result);
        return NULL;
    }
    return capsule;
}
...
kth_py_native_chain_output_construct_from_data(PyObject* self, PyObject* args, PyObject* kwds) {
    ...
    PyObject* capsule = PyCapsule_New((void*)out, KTH_PY_CAPSULE_CHAIN_OUTPUT, kth_py_native_chain_output_capsule_dtor);
    if (capsule == NULL) {
...
kth_py_native_chain_output_copy(PyObject* self, PyObject* py_arg0) {
    ...
    auto const result = kth_chain_output_copy(self_handle);
    if (result == NULL) {
        PyErr_SetString(PyExc_MemoryError, "kth: allocation failed");
        return NULL;
    }
...
kth_py_native_chain_output_to_data(PyObject* self, PyObject* args, PyObject* kwds) {
    ...
    auto const result = kth_chain_output_to_data(self_handle, (kth_bool_t)wire, &out_size);
    if (result == NULL) {
...
kth_py_native_chain_output_serialized_size(PyObject* self, PyObject* args, PyObject* kwds) {
    ...
    kth_output_const_t self_handle = (kth_output_const_t)PyCapsule_GetPointer(py_self, KTH_PY_CAPSULE_CHAIN_OUTPUT);
    if (self_handle == NULL) return NULL;
    auto const result = kth_chain_output_serialized_size(self_handle, (kth_bool_t)wire);
...
kth_py_native_chain_output_address_simple(PyObject* self, PyObject* args, PyObject* kwds) {
    ...
    kth_output_const_t self_handle = (kth_output_const_t)PyCapsule_GetPointer(py_self, KTH_PY_CAPSULE_CHAIN_OUTPUT);
    if (self_handle == NULL) return NULL;
    auto const result = kth_chain_output_address_simple(self_handle, (kth_bool_t)testnet);
    if (result == NULL) {
...
kth_py_native_chain_output_address(PyObject* self, PyObject* args, PyObject* kwds) {
    ...
    kth_output_const_t self_handle = (kth_output_const_t)PyCapsule_GetPointer(py_self, KTH_PY_CAPSULE_CHAIN_OUTPUT);
    if (self_handle == NULL) return NULL;
    auto const result = kth_chain_output_address(self_handle, (uint8_t)p2kh_version, (uint8_t)p2sh_version);
    if (result == NULL) {
        PyErr_SetString(PyExc_RuntimeError, "kth: NULL handle returned");
        return NULL;
    }
...
kth_py_native_chain_output_addresses(PyObject* self, PyObject* args, PyObject* kwds) {
    ...
    kth_output_const_t self_handle = (kth_output_const_t)PyCapsule_GetPointer(py_self, KTH_PY_CAPSULE_CHAIN_OUTPUT);
    if (self_handle == NULL) return NULL;
    auto const result = kth_chain_output_addresses(self_handle, (uint8_t)p2kh_version, (uint8_t)p2sh_version);
    if (result == NULL) {
...
kth_py_native_chain_output_equals(PyObject* self, PyObject* args, PyObject* kwds) {
    ...
    auto const result = kth_chain_output_equals(self_handle, other_handle);
...
kth_py_native_chain_output_is_valid(PyObject* self, PyObject* py_arg0) {
    ...
    kth_output_const_t self_handle = (kth_output_const_t)PyCapsule_GetPointer(py_self, KTH_PY_CAPSULE_CHAIN_OUTPUT);
    if (self_handle == NULL) return NULL;
    auto const result = kth_chain_output_is_valid(self_handle);
    return PyBool_FromLong((long)result);
}
...
kth_py_native_chain_output_value(PyObject* self, PyObject* py_arg0) {
    ...
    kth_output_const_t self_handle = (kth_output_const_t)PyCapsule_GetPointer(py_self, KTH_PY_CAPSULE_CHAIN_OUTPUT);
    if (self_handle == NULL) return NULL;
    auto const result = kth_chain_output_value(self_handle);
...
kth_py_native_chain_output_script(PyObject* self, PyObject* py_arg0) {
    ...
    kth_output_const_t self_handle = (kth_output_const_t)PyCapsule_GetPointer(py_self, KTH_PY_CAPSULE_CHAIN_OUTPUT);
    if (self_handle == NULL) return NULL;
    auto const result = kth_chain_output_script(self_handle);
    if (result == NULL) {
        PyErr_SetString(PyExc_RuntimeError, "kth: NULL handle returned");
        return NULL;
    }
...
kth_py_native_chain_output_signature_operations(PyObject* self, PyObject* args, PyObject* kwds) {
    ...
    kth_output_const_t self_handle = (kth_output_const_t)PyCapsule_GetPointer(py_self, KTH_PY_CAPSULE_CHAIN_OUTPUT);
    if (self_handle == NULL) return NULL;
    auto const result = kth_chain_output_signature_operations(self_handle, (kth_bool_t)bip141);
    return PyLong_FromSize_t((size_t)result);
}
...
kth_py_native_chain_output_is_dust(PyObject* self, PyObject* args, PyObject* kwds) {
    ...
    kth_output_const_t self_handle = (kth_output_const_t)PyCapsule_GetPointer(py_self, KTH_PY_CAPSULE_CHAIN_OUTPUT);
    if (self_handle == NULL) return NULL;
    auto const result = kth_chain_output_is_dust(self_handle, (uint64_t)minimum_output_value);
    return PyBool_FromLong((long)result);
}
